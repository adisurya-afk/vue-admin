...
<p align="center">
  ...
  <a href="https://travis-ci.org/PanJiaChen/vue-admin" rel="nofollow">
    <img src="https://travis-ci.org/PanJiaChen/vue-admin.svg?branch=master" alt="Estado de Construcción">
  </a>
  ...
  <a href="https://github.com/PanJiaChen/vue-admin/releases">
    <img src="https://img.shields.io/github/release/PanJiaChen/vue-admin.svg" alt="Liberación Github">
  </a>
...
[vue-admin](https://panjiachen.github.io/vue-admin) es una interfáz de administración preparada para producción. Está basada en [vue](https://github.com/vuejs/vue) y usa [element-ui](https://github.com/ElemeFE/element) como conjunto de herramientas de interfáz de usuario.
...
- [Vista Prévia de la Aplicación](https://panjiachen.github.io/vue-admin)

- [Documentación](https://panjiachen.github.io/vue-admin-site/)

- [Canal de Gitter](https://gitter.im/vue-admin/discuss)

- [Para Donaciones](https://panjiachen.github.io/vue-admin-site/donate/)

- [Enlace de Wiki](https://github.com/PanJiaChen/vue-admin/wiki)

- [Canal de Gitee](https://panjiachen.gitee.io/vue-admin/)
...
**Después de la versión `v4.1.0+`, la rama por defecto master no tendrá soporte para i18n. Por favor utilice la rama [i18n](https://github.com/PanJiaChen/vue-admin/tree/i18n), los cambios serán incluidos en la rama master**

**la versión actual es `v4.0+` construida con `vue-cli`. Si encuentra algún problema, por favor coloque un [issue](https://github.com/PanJiaChen/vue-admin/issues/new). Si desea usar la versión anterior, puede cambiar de rama a [tag/3.11.0](https://github.com/PanJiaChen/vue-admin/tree/tag/3.11.0), no relacionado con `vue-cli`**
...
<a href="https://flatlogic.com/admin-dashboards?from=vue-admin"><img width="150px" src="https://wpimg.wallstcn.com/9c0b719b-5551-4c1e-b776-63994632d94a.png" /></a><p>Plantilla de Dashboard de administración hecha con Vue, React y Angular.</p>
...
Vaya a [Documentación](https://panjiachen.github.io/vue-admin-site/guide/essentials/deploy.html) para mayor información

## Registro de Cambios

Los cambios detallados por cada liberación se encuentran en [notas de liberación](https://github.com/PanJiaChen/vue-admin/releases).
