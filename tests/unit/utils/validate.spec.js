...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/PanJiaChen/vue-admin')).toBe(true)
    expect(validURL('http://github.com/PanJiaChen/vue-admin')).toBe(true)
    expect(validURL('github.com/PanJiaChen/vue-admin')).toBe(false)
  })
  it('validLowerCase', () => {
